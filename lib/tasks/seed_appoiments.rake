...
task :seed_appoinments => :environment do
  ...
  appointments = [
    ...
    },
    {
      ...
      end_time: Time.new(2018, 11, 30, 10) + (peluqueria_medicado.duration_min).minutes,
    ...
    },
    {
      ...
      # client_phone: '0997115647',
      start_time: Time.new(2018, 11, 30, 11),
      end_time: Time.new(2018, 11, 30, 11) + (peluqueria_normal.duration_min).minutes,
      remark: "__Especie__: Canina\n- __Raza__: Shitzu\n- __Sexo__: Hembra",
    },
  ]
...
# Appointment.create!({ specialist_id: 1, service_id: 1, client_name: 'Dra Ariana', start_time: Time.new(2018, 11, 30, 11), end_time: Time.new(2018, 11, 30, 11) + (peluqueria_normal.duration_min).minutes, remark: "__Especie__: Canina\n- __Raza__: Shitzu\n- __Sexo__: Hembra"})
