...
const specialistSchema = new schema.Entity('specialists', {}, {
  idAttribute: specialist => specialist.id,
})

const serviceSchema = new schema.Entity('services', {
  specialists: specialistSchema,
}, {
  idAttribute: service => service.id,
})
...
export const Schemas = {
  ...
  SPECIALIST: specialistSchema,
  SPECIALIST_ARRAY: [specialistSchema],
